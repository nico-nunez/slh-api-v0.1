...
module.exports.addListToParty = catchAsync(async (req, res, next) => {
  ...
  const newNotification = new Notification({
    ...
    generator: foundParty._id,
    recipients: foundParty.subscribers,
  });
...
module.exports.updatePartyDetails = catchAsync(async (req, res, next) => {
  ...
  const newNotification = new Notification({
    content: `${req.user.displayName} has updated party - ${foundParty.title}`,
    generator: foundParty._id,
    recipients: foundParty.subscribers,
  });
  await newNotification.save();
...
module.exports.deleteParty = catchAsync(async (req, res, next) => {
  ...
  const newNotification = new Notification({
    content: `${req.user.displayName} has delete party - ${foundParty.title}`,
    generator: foundParty._id,
    recipients: foundParty.subscribers,
  });
  await newNotification.save();
